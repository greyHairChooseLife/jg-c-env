...
void frontBackSplitLinkedList(LinkedList* ll,
...
int main() {
    ...
    printf(
        "2: Split the linked list into two linked lists, frontList and "
        "backList:\n");
    printf("0: Quit:\n");
    ...
    while (c != 0) {
        ...
        switch (c) {
            ...
            case 2:
                printf(
                    "The resulting linked lists after splitting the given "
                    "linked list "
                    "are:\n");
