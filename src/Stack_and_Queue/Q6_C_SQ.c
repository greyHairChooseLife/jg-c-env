...
int main() {
    ...
    while (c != 0) {
        ...
        switch (c) {
            case 1:
                printf(
                    "Input an integer that you want to insert into the "
                    "stack: ");
                scanf("%d", &i);
                push(&s, i);
            ...
            case 2:
                printf(
                    "Enter an integer value in stack to remove values until "
                    "that value: ");
                scanf("%d", &i);
                removeUntil(&s, i);  // You need to code this function
                printf(
                    "The resulting stack after removing values until the given "
                    "value: ");
                printList(&(s.ll));
...
void removeUntil(Stack* s, int value) { /* add your code here */ }
