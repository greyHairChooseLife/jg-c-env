...
int main() {
    ...
    while (c != 0) {
        ...
        switch (c) {
            case 1:
                printf(
                    "Input an integer that you want to insert into the Binary "
                    "Search Tree: ");
                scanf("%d", &i);
            ...
            case 2:
                printf(
                    "The resulting level-order traversal of the binary search "
                    "tree is: ");
                levelOrderTraversal(root);  // You need to code this function
                printf("\n");
                break;
            case 0: removeAll(&root); break;
...
void levelOrderTraversal(BSTNode* root) { /* add your code here */ }
